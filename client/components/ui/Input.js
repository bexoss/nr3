...
export default function Input({ label, description, error, className = '', inputClassName = '', ...props }) {
  const id = useId()
  ...
  return (
    <div className={['w-full', className].join(' ')}>
      ...
      <input id={id} className={[base, error ? invalid : normal, inputClassName].join(' ')} {...props} />
